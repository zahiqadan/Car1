...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('dispatcher.geo-fencing.update', $show->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <a href="{{route('dispatcher.geo-fencing.index')}}" class="btn btn-danger btn-block">@lang('admin.cancel')</a>
                    </div>
