...
<div class="row white-section no-margin">
    <div class="container">
        <div class="col-md-12"><h2 style="margin:0; text-align: center; cursor: pointer;"><a href="{{url('ride#estimate-fare')}}">Before tapping check fare details</a></h2></div>
...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>A city with {{ Setting::get('site_title', 'Tranxit') }} has more economic opportunities for residents.</p>
