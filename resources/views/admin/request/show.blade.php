            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">
                            @if(@$request->user)
                            <a href="{{url('admin/user/'.$request->user->id)}}">{{ $request->user?@$request->user->first_name:'' }}</a>
                            @else
                            N/A
                            @endif
                        </dd>
                        ...
                        @if($request->provider)
                        <dd class="col-sm-8"><a href="{{url('admin/provider/'.$request->provider->id)}}">{{ $request->provider?$request->provider->first_name:'' }}</a></dd>
                        @else
                        ...
                        <dt class="col-sm-4">ETA Discount Price :</dt>
                        <dd class="col-sm-8">{{ currency($request->payment->eta_discount) }}</dd>
