    ...
    <div class="row row-md">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('admin.dashboard.total_user')</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">@lang('admin.dashboard.total_provider')</h6>
					<h1 class="mb-1">{{$provider_count}}</h1>
					@foreach($service as $key => $value) 
					<span>{{$value->name}} : </span> <span class="tag tag-danger mr-0-5">{{$value->count}}</span><br>
					@endforeach
				</div>
			</div>
		</div>
