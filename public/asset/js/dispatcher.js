                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12">
                            <div className="form-group">
                                ...
                                <input type="text" name="s_latitude" id="s_latitude"></input>
                                <input type="text" name="s_longitude" id="s_longitude"></input>
                            </div>
                            <div className="form-group">
                                ...
                                <input type="text" name="d_latitude" id="d_latitude"></input>
                                <input type="text" name="d_longitude" id="d_longitude"></input>
                                <input type="text" name="distance" id="distance"></input>
                            </div>
                            <div className="form-group">
...
class UserEstimateFare extends React.Component {
    ...
    resetTrip() {
       window.location.replace("/dispatcher/dispatcher");
    }
     handleClick() {
         window.location.replace("/dispatcher/dispatcher/cancel?request_id="+this.props.trip.id);
    }
                   ...
                   <table className="table table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>${this.props.estimateview.estimated_fare}</td>
                      </tr>
                    </tbody>
                  </table>
                    <div className="row">
                        <div className="col-xs-6">
                            <button type="button" className="btn btn-md btn-danger btn-block waves-effect waves-light" onClick={this.handleClick.bind()}>
                                Cancel Ride
                            </button>
                        </div>
                        </div>
